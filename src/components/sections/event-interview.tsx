...
export default function EventInterview() {
  return (
    <section className="relative py-16 sm:py-24 bg-background text-foreground overflow-x-hidden border-t border-border">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-10 sm:gap-16 lg:gap-20">
          ...
          >
            <div className="space-y-4">
              ...
              <h2 className="text-[clamp(2rem,5vw,4.5rem)] font-bold leading-[1.05] tracking-tight text-foreground">
                Weekly Politics <br className="hidden lg:block" />
                <span className="text-muted-foreground font-light italic">Interview</span>
              </h2>
            </div>
            
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 leading-relaxed font-light">
            ...
            <div className="pt-4 flex items-center justify-center lg:justify-start gap-4">
              <div className="flex items-center gap-3 px-6 py-3 rounded-full border border-border bg-muted/20 backdrop-blur-sm">
          ...
          >
            <div className="relative rounded-[2.5rem] overflow-hidden bg-card border border-border shadow-[0_20px_50px_rgba(0,0,0,0.15)] aspect-video group">
              <video 
            ...
            <div className="mt-6 flex items-center justify-between text-sm text-muted-foreground px-4">
        ...
        <motion.div
          ...
          className="mt-20 w-full max-w-5xl mx-auto rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] relative border border-border"
        >
          <img 
