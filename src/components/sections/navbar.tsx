    ...
    >
      <div 
        className={`flex w-full transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
          isScrolled ? 'max-w-[320px] md:max-w-[380px] justify-center gap-2 md:gap-3' : 'px-[5vw] justify-between'
        }`}
      >
        {/* Logo Container */}
        ...
        >
          <AnimatePresence mode="popLayout">
            {isScrolled ? (
              ...
              >
                CEBAR Group<span className="text-[0.6rem] ml-[2px] mt-[2px] text-white/50">™</span>
              </motion.span>
            ) : (
              <motion.span 
                key="text-unscrolled"
              ...
              >
                CEBAR Group<span className="text-[0.7rem] ml-[2px] mt-[2px] text-white/50">™</span>
              </motion.span>
            )}
          </AnimatePresence>
          </motion.a>
