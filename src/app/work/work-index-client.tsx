            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-3 rounded-full border text-xs font-bold tracking-widest uppercase transition-all duration-500 ${
                  activeCategory === cat 
                    ? "bg-[#D1000A] border-[#D1000A] text-white" 
              ...
              >
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                  <div className="flex items-center gap-12">
                    <span className="text-xs font-bold text-[#D1000A] opacity-40 group-hover:opacity-100 transition-opacity">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center transition-all group-hover:bg-[#D1000A] group-hover:border-[#D1000A]">
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="group-hover:text-white transition-colors">
      ...
      <section className="py-[20vh] px-[5vw] bg-white text-[#111] rounded-t-[4rem]">
        <div className="max-w-[1600px] mx-auto text-center">
          ...
          <MagneticButton>
            <Link 
              href="/contact"
              className="w-48 h-48 md:w-64 md:h-64 rounded-full bg-[#111] text-white flex items-center justify-center text-xs font-bold tracking-[0.2em] uppercase transition-colors hover:bg-[#D1000A] hover:text-white group"
            >
